...
const Cart = () => {
  ...
  return (
    <div className="container mx-auto p-6 min-h-screen bg-gray-100">
      <h2 className="text-4xl font-bold text-gray-800 mb-6 text-center">🛒 Shopping Cart</h2>

      {cartItems.length === 0 ? (
        <p className="text-gray-600 text-lg text-center mt-10">Your cart is empty. Start shopping now! 🛍️</p>
      ) : (
          ...
          {cartItems.map((item) => (
            ...
            >
              ...
              <div className="flex-1 ml-5">
                ...
                <p className="text-gray-600 text-sm">Price: <span className="font-bold">${item.price}</span></p>
              </div>
